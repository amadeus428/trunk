...
public class UiTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testDrawer() throws InterruptedException {
		...
		button = (Button) mActivity
				.findViewById(R.id.fragment_sound_profile_open_button);
		assertNotNull(button);
	...
	/*
	 * public void testSoundProfile() { mActivity.runOnUiThread(new Runnable() {
	 * public void run() { ((Button) mActivity
	 * .findViewById(R.id.fragment_home_sound_profile_button)) .performClick();
	 * 
	 * } });
	 * 
	 * mInstrumentation.waitForIdleSync(); Button button =
	 * (Button)mActivity.findViewById(R.id.fragment_sound_profile_open_button);
	 * button.performClick();
	 * 
	 * }
	 */
