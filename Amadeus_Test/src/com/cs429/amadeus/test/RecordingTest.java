...
public class RecordingTest extends
	...
	public void setUp() throws Exception {
		...
		// mPlaybackButton =
		// (Button)mActivity.findViewById(com.cs429.amadeus.R.id.playback);
		// mStartStopButton =
		// (Button)mActivity.findViewById(com.cs429.amadeus.R.id.startstop);
		// mFileNameField =
		// (EditText)mActivity.findViewById(com.cs429.amadeus.R.id.fileNameField);
	}
