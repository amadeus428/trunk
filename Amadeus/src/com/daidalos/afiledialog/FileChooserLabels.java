...
/**
 * Instances of this classes are used to re-define the value of the labels of a
 * file chooser.
 * 
...
public class FileChooserLabels implements Serializable {
	...
	/**
	 * The label for the button for select the current folder (when using the
	 * file chooser for select folders).
	 */
	 ...
	 * 
	 * In this string, the character sequence '$file_name' is going to be
	 * replace by the file's name.
	 */
	...
	/**
	 * The label for the 'yes' button when confirming the selection o creation
	 * of a file.
	 */
	public String labelConfirmYesButton;

	/**
	 * The label for the 'no' button when confirming the selection o creation of
	 * a file.
	 */
