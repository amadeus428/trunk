...
public class PlayAlongFragment extends Fragment
{
	...
	public void onActivityCreated(Bundle savedInstanceState)
	{
		...
		staffLayout = (PlayAlongStaffLayout)getActivity().findViewById(R.id.fragment_play_along_staff_layout);

		bpmSpinner = (Spinner)getActivity().findViewById(R.id.fragment_play_along_bpm_spinner);
	...
	{
		final Button openButton = (Button)getActivity().findViewById(R.id.fragment_play_along_open_recording_button);
		...
		final Button startStopButton = (Button)getActivity().findViewById(R.id.fragment_play_along_start_stop_button);
		...
		playStopNotesButton = (ImageButton)getActivity().findViewById(R.id.fragment_play_along_play_stop_notes_button);
	...
	{
		midiPlayer = new PlayAlongStaffMIDIPlayer(getActivity(), staffLayout, getBPM())
		{
			@Override
	...
	private void createScoreDialog()
	{
		...
		scoreDialog.setTitle("PlayAlong score")
